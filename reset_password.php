    ...
    <div class="login-mai">  	
			<div class="login-block">
				<form action="reset-conn3.php" method="post" class="login">
					<div class="ast show1">
						<input type="text" style="width:100%" name="email" class="email" placeholder="Enter Your Email To Reset password">
					...
					<div class="ast show2">
						<input type="text" style="width:100%" name="phone" class="phone" placeholder="Enter Your Phone Number To Reset Password">
						<i class="fa fa-check check"></i>
						<i class="fa fa-close close"></i>
